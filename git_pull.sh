...
ShellURL=${JD_SHELL_URL:-https://ghproxy.com/https://github.com/baipiaoyonghu/jd-shell.git}
ScriptsURL=${JD_SCRIPTS_URL:-https://ghproxy.com/https://github.com/baipiaoyonghu/jd-scripts.git}
